  ...
  const servicePoints = [
    {
      ...
      services: ['Registro de víctimas', 'Atención psicosocial', 'Trámites administrativos'],
      color: 'bg-blue-500'
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Encuentra fácilmente todos los puntos de atención en Nobsa. 
            Aquí tienes la información completa para acceder a cada servicio.
          </p>
        </div>
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-gray-700 font-medium">{point.address}</p>
                      <p className="text-gray-500 text-sm">{point.coordinates}</p>
                    </div>
                  </div>
                ...
                <div className="mt-6">
                  <h4 className="font-bold text-gray-800 mb-3">Servicios disponibles:</h4>
        ...
        <div className="mt-12 bg-red-50 border border-red-200 rounded-lg p-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-red-800">Línea de Emergencia</h3>
              <p className="text-red-600">Para situaciones que requieren atención inmediata</p>
            </div>
          </div>
